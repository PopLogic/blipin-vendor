  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      void updateScrollState() {
        ...
        if (canAgree.value != atEnd) canAgree.value = atEnd;
      }
